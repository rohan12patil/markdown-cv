...
- Played a key role in testing several Progressive Web Apps (PWAs), resulting in significant cost savings.
- Proposed and integrated organisation-specific authentication testing for hybrid apps, enhancing security.

### Senior Mobile App QA
**Deutsche Bank | TCS** · Frankfurt, Germany  
_Jul 2018 – Aug 2021_

- Automated frontend testing using Appium for client-side mobile applications, achieving 75% test coverage.
- Collaborated with cross-functional teams to ensure high-quality delivery of SaaS-based financial tools.
- Led creation of detailed test plans, reducing production defects by 30%.
- Performed end-to-end testing including integration of REST APIs and event-driven architectures.

### QA Engineer
**Eaton | TCS** · Cleveland, USA  
_Jan 2016 – Jun 2018_

- Contributed to development of the PowerXpert Meters Dashboard using AngularJS, WebSockets, PolymerJS & Highcharts.
- Established best practices and optimised dashboard performance for continuous 24×7 operation.
- Tested PowerXpert Meters Dashboard hardware under stringent continuous-operation requirements.
- Mentored three junior colleagues, fostering knowledge transfer and quality standards.

### QA Web & Mobile Apps
**DuPont USA | TCS** · Pune, India  
_Dec 2012 – Dec 2015_

- Partnered with cross-functional teams to align mobile app features with business objectives.
- Conducted thorough analysis of user feedback and app metrics; tested targeted improvements to boost functionality.
- Maintained high standards of quality and reliable testing across multiple app versions and platforms.
